      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-stone-900 border border-stone-800 p-10 shadow-2xl relative overflow-hidden">
          ...
          <div className="text-center mb-10">
            <h1 className="text-3xl font-serif text-white mb-2">Member Login</h1>
            <p className="text-stone-500 font-light text-sm uppercase tracking-widest">Access your private account</p>
          </div>
          ...
          <div className="mb-8 bg-stone-950 border border-stone-800 p-4">
            <p className="text-xs text-amber-500 font-serif mb-2 uppercase tracking-wide">Demo Access</p>
            <ul className="text-xs text-stone-500 space-y-1 font-mono">
              <li>• Email containing "manager" → Venue Manager</li>
              <li>• Other emails → Customer</li>
            </ul>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className="w-full bg-amber-600 text-white py-4 hover:bg-amber-700 transition-colors uppercase tracking-widest text-xs font-bold disabled:opacity-50 disabled:cursor-not-allowed mt-4"
            >
          ...
          <div className="mt-8 text-center border-t border-stone-800 pt-6">
            <p className="text-stone-500 text-sm font-light">
              Not a member?{' '}
              <Link to="/register" className="text-amber-500 hover:text-amber-400 transition-colors ml-1 uppercase text-xs tracking-wider">
                Apply here
              </Link>
            </p>
          </div>
